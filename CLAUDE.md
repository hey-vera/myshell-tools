...
**Product north star:** "one chat to rule them all" — a single, provider-agnostic terminal chat/agent surface. Current state: `docs/ROADMAP-STATUS.md`. The user-designated active build plan is `CLAUDEPLAN.md`; older plans and audits are historical context only.
